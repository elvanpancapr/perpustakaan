...
<div class="row">
    <div class="col-sm-12" style="position: right">
        ...
        <h4 class="page-title">Halaman Data Anggota</h4>
    </div>
</div>
<div class="row">
    <div class="col-sm-12" style="height: 300px; background-color: white">
        <button type="button" class="btn btn-info waves-effect waves-light w-md" style="margin-left: 20px; margin-top: 25px">Anggota Baru</button>
        <button type="button" class="btn btn-info waves-effect waves-light w-md" style="margin-left: 10px; margin-top: 25px">Cetak Kartu Anggota</button>
